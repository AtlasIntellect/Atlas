...
/// <summary>
/// Provides unit tests for the <see cref="Atlas.Core.Memory.AtlasMemoryInterpreter"/> class.
/// </summary>
public sealed class AtlasMemoryInterpreterTests
{
    /// <summary>
    /// Verifies that the <see cref="Atlas.Core.Memory.AtlasMemoryInterpreter.Interpret(string, Atlas.Abstractions.Memory.AtlasMemoryType)"/> method
